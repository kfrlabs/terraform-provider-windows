...
page_title: "windows_localgroup Data Source - windows"
subcategory: ""
description: |-
  Reads information about a Windows local group.
...
- `name` (String) The name of the local group to look up.
...
- `id` (String) Unique identifier for the data source (same as name).
...
- `sid` (String) The Security Identifier (SID) of the group. This is a unique identifier in the format S-1-5-...
